...
echo -e "\e[035;1m _______  ________ _      __       .\e[0m"
echo -e "\e[035;1m|       ||  ____ \| \    /||\     /|\e[0m"
echo -e "\e[035;1m| || || || |    \/|  \  | || |   | |\e[0m"
echo -e "\e[035;1m| || || || |__    |   \ | || |   | |\e[0m"
echo -e "\e[035;1m| ||_|| ||  __)   | |\ \| || |   | |\e[0m"
echo -e "\e[035;1m| |   | || |      | | \   || |   | |\e[0m"
echo -e "\e[035;1m| |   | || |____/\| |  \  || |___| |\e[0m"
echo -e "\e[035;1m|/     \||_______/|/    \_||_______|\e[0m"
    echo "----------------------------------------------------"
...
if [ $? -eq 0 ]; then
	...
	echo -e "\e[035;1m-------------------------------------------------"
	echo -e "\e[033;1mData Login User Dan Pass Serta Ip-Proxy:"
	echo -e "\e[035;1m-------------------------------------------------"
	echo "========================="
	echo "Host IP : $myip"
	echo "Port    : 443/22/80"
...
chmod +x speedtest.py
       ...
       free -m 
		...
		33)
		    clear
            wget https://raw.githubusercontent.com/Infotricky/Script.menu/master/Benhcmark && bash Benhcmark
           ;;
        34)
       passwd
			;;	
